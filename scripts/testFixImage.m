...
for iZ = 1:reader.sizeZ
    ...
    imwrite(Iout, ['20230420_beads\20230420_beads_corrected_z', int2str(iZ), '.tif'], 'Compression', 'none');

    Iout = imfuse(Icy5norm, Itritcnorm);
    % imwrite(Iout, ['20230302_slide119_2\20230419_original_z', int2str(iZ), '.tif'], 'Compression', 'none');
    imwrite(Iout, ['20230420_beads\20230420_beads_original_z', int2str(iZ), '.tif'], 'Compression', 'none');
